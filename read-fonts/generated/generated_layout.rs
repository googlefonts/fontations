...
impl<'a> FontRead<'a> for ScriptList<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let script_records_byte_len =
            (script_count as usize).saturating_mul(ScriptRecord::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for Script<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let lang_sys_records_byte_len =
            (lang_sys_count as usize).saturating_mul(LangSysRecord::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for LangSys<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let feature_indices_byte_len =
            (feature_index_count as usize).saturating_mul(u16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for FeatureList<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let feature_records_byte_len =
            (feature_count as usize).saturating_mul(FeatureRecord::RAW_BYTE_LEN);
...
impl<'a> FontReadWithArgs<'a> for Feature<'a> {
    fn read_with_args(data: FontData<'a>, args: &Tag) -> Result<Self, ReadError> {
        ...
        let lookup_list_indices_byte_len =
            (lookup_index_count as usize).saturating_mul(u16::RAW_BYTE_LEN);
...
impl<'a, T> FontRead<'a> for LookupList<'a, T> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let lookup_offsets_byte_len =
            (lookup_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a, T> FontRead<'a> for Lookup<'a, T> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let subtable_offsets_byte_len =
            (sub_table_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for CoverageFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let glyph_array_byte_len = (glyph_count as usize).saturating_mul(GlyphId::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for CoverageFormat2<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let range_records_byte_len =
            (range_count as usize).saturating_mul(RangeRecord::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ClassDefFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let glyph_count: u16 = cursor.read()?;
        let class_value_array_byte_len = (glyph_count as usize).saturating_mul(u16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ClassDefFormat2<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let class_range_records_byte_len =
            (class_range_count as usize).saturating_mul(ClassRangeRecord::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for SequenceContextFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let seq_rule_set_offsets_byte_len =
            (seq_rule_set_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for SequenceRuleSet<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let seq_rule_offsets_byte_len =
            (seq_rule_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for SequenceRule<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let input_sequence_byte_len =
            (transforms::subtract(glyph_count, 1_usize)).saturating_mul(GlyphId::RAW_BYTE_LEN);
        cursor.advance_by(input_sequence_byte_len);
        let seq_lookup_records_byte_len =
            (seq_lookup_count as usize).saturating_mul(SequenceLookupRecord::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for SequenceContextFormat2<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let class_seq_rule_set_offsets_byte_len =
            (class_seq_rule_set_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ClassSequenceRuleSet<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let class_seq_rule_offsets_byte_len =
            (class_seq_rule_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ClassSequenceRule<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let seq_lookup_count: u16 = cursor.read()?;
        let input_sequence_byte_len =
            (transforms::subtract(glyph_count, 1_usize)).saturating_mul(u16::RAW_BYTE_LEN);
        cursor.advance_by(input_sequence_byte_len);
        let seq_lookup_records_byte_len =
            (seq_lookup_count as usize).saturating_mul(SequenceLookupRecord::RAW_BYTE_LEN);
        cursor.advance_by(seq_lookup_records_byte_len);
...
impl<'a> FontRead<'a> for SequenceContextFormat3<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let glyph_count: u16 = cursor.read()?;
        let seq_lookup_count: u16 = cursor.read()?;
        let coverage_offsets_byte_len =
            (glyph_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ChainedSequenceContextFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let chained_seq_rule_set_offsets_byte_len =
            (chained_seq_rule_set_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ChainedSequenceRuleSet<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let chained_seq_rule_offsets_byte_len =
            (chained_seq_rule_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ChainedSequenceRule<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let backtrack_sequence_byte_len =
            (backtrack_glyph_count as usize).saturating_mul(GlyphId::RAW_BYTE_LEN);
        ...
        let input_sequence_byte_len = (transforms::subtract(input_glyph_count, 1_usize))
            .saturating_mul(GlyphId::RAW_BYTE_LEN);
        cursor.advance_by(input_sequence_byte_len);
        let lookahead_glyph_count: u16 = cursor.read()?;
        let lookahead_sequence_byte_len =
            (lookahead_glyph_count as usize).saturating_mul(GlyphId::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ChainedClassSequenceRuleSet<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let chained_class_seq_rule_offsets_byte_len =
            (chained_class_seq_rule_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ChainedClassSequenceRule<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let backtrack_glyph_count: u16 = cursor.read()?;
        let backtrack_sequence_byte_len =
            (backtrack_glyph_count as usize).saturating_mul(u16::RAW_BYTE_LEN);
        cursor.advance_by(backtrack_sequence_byte_len);
        let input_glyph_count: u16 = cursor.read()?;
        let input_sequence_byte_len =
        ...
        let lookahead_glyph_count: u16 = cursor.read()?;
        let lookahead_sequence_byte_len =
            (lookahead_glyph_count as usize).saturating_mul(u16::RAW_BYTE_LEN);
        cursor.advance_by(lookahead_sequence_byte_len);
        let seq_lookup_count: u16 = cursor.read()?;
        let seq_lookup_records_byte_len =
            (seq_lookup_count as usize).saturating_mul(SequenceLookupRecord::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ChainedSequenceContextFormat3<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let backtrack_coverage_offsets_byte_len =
            (backtrack_glyph_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
        cursor.advance_by(backtrack_coverage_offsets_byte_len);
        let input_glyph_count: u16 = cursor.read()?;
        let input_coverage_offsets_byte_len =
            (input_glyph_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
        cursor.advance_by(input_coverage_offsets_byte_len);
        let lookahead_glyph_count: u16 = cursor.read()?;
        let lookahead_coverage_offsets_byte_len =
            (lookahead_glyph_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for ConditionFormat3<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let condition_offsets_byte_len =
            (condition_count as usize).saturating_mul(Offset24::RAW_BYTE_LEN);
        cursor.advance_by(condition_offsets_byte_len);
...
impl<'a> FontRead<'a> for CharacterVariantParams<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let character_byte_len = (char_count as usize).saturating_mul(Uint24::RAW_BYTE_LEN);
