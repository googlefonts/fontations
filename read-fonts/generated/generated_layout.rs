...
impl<'a> Sanitize<'a> for Feature<'a> {
    ...
    fn read_fast(data: FontData<'a>, args: Tag) -> Option<Self> {
        let feature_tag = args;
        read_fast_impl!(Self { data, feature_tag })
    }
}
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            CoverageFormat1::FORMAT => {
                CoverageFormat1::read_fast(data, ()).map(CoverageTable::Format1)
            }
            CoverageFormat2::FORMAT => {
                CoverageFormat2::read_fast(data, ()).map(CoverageTable::Format2)
            }
            _ => None,
        }
    }
...
impl<'a> Sanitize<'a> for ClassDef<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        let format = data.read_at::<u16>(0usize).ok()?;
        match format {
            ClassDefFormat1::FORMAT => ClassDefFormat1::read_fast(data, ()).map(ClassDef::Format1),
            ClassDefFormat2::FORMAT => ClassDefFormat2::read_fast(data, ()).map(ClassDef::Format2),
            _ => None,
        }
    }
}
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            SequenceContextFormat1::FORMAT => {
                SequenceContextFormat1::read_fast(data, ()).map(SequenceContext::Format1)
            }
            SequenceContextFormat2::FORMAT => {
                SequenceContextFormat2::read_fast(data, ()).map(SequenceContext::Format2)
            }
            SequenceContextFormat3::FORMAT => {
                SequenceContextFormat3::read_fast(data, ()).map(SequenceContext::Format3)
            }
            _ => None,
        }
    }
...
impl<'a> Sanitize<'a> for ChainedSequenceContext<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            ChainedSequenceContextFormat1::FORMAT => {
                ChainedSequenceContextFormat1::read_fast(data, ())
                    .map(ChainedSequenceContext::Format1)
            }
            ChainedSequenceContextFormat2::FORMAT => {
                ChainedSequenceContextFormat2::read_fast(data, ())
                    .map(ChainedSequenceContext::Format2)
            }
            ChainedSequenceContextFormat3::FORMAT => {
                ChainedSequenceContextFormat3::read_fast(data, ())
                    .map(ChainedSequenceContext::Format3)
            }
            _ => None,
        }
    }
...
impl<'a> Sanitize<'a> for DeviceOrVariationIndex<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        let format = data.read_at::<DeltaFormat>(4usize).ok()?;

        #[allow(clippy::redundant_guards)]
        match format {
            format if format != DeltaFormat::VariationIndex => {
                Device::read_fast(data, ()).map(DeviceOrVariationIndex::Device)
            }
            format if format == DeltaFormat::VariationIndex => {
                VariationIndex::read_fast(data, ()).map(DeviceOrVariationIndex::VariationIndex)
            }
            _ => None,
        }
    }
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            ConditionFormat1::FORMAT => {
                ConditionFormat1::read_fast(data, ()).map(Condition::Format1AxisRange)
            }
            ConditionFormat2::FORMAT => {
                ConditionFormat2::read_fast(data, ()).map(Condition::Format2VariableValue)
            }
            ConditionFormat3::FORMAT => {
                ConditionFormat3::read_fast(data, ()).map(Condition::Format3And)
            }
            ConditionFormat4::FORMAT => {
                ConditionFormat4::read_fast(data, ()).map(Condition::Format4Or)
            }
            ConditionFormat5::FORMAT => {
                ConditionFormat5::read_fast(data, ()).map(Condition::Format5Negate)
            }
            _ => None,
        }
    }
