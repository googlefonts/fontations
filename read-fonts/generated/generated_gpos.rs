...
impl<'a> Sanitize<'a> for PositionLookup<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        let discriminant = Lookup::read_discriminant(data).ok()?;
        match discriminant {
            1 => Lookup::<SinglePos>::read_fast(data, ()).map(PositionLookup::Single),
            2 => Lookup::<PairPos>::read_fast(data, ()).map(PositionLookup::Pair),
            3 => Lookup::<CursivePosFormat1>::read_fast(data, ()).map(PositionLookup::Cursive),
            4 => Lookup::<MarkBasePosFormat1>::read_fast(data, ()).map(PositionLookup::MarkToBase),
            5 => Lookup::<MarkLigPosFormat1>::read_fast(data, ()).map(PositionLookup::MarkToLig),
            6 => Lookup::<MarkMarkPosFormat1>::read_fast(data, ()).map(PositionLookup::MarkToMark),
            7 => Lookup::<PositionSequenceContext>::read_fast(data, ())
                .map(PositionLookup::Contextual),
            8 => Lookup::<PositionChainContext>::read_fast(data, ())
                .map(PositionLookup::ChainContextual),
            9 => Lookup::<ExtensionSubtable>::read_fast(data, ()).map(PositionLookup::Extension),
            _ => None,
        }
    }
}
...
impl<'a> Sanitize<'a> for AnchorTable<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            AnchorFormat1::FORMAT => AnchorFormat1::read_fast(data, ()).map(AnchorTable::Format1),
            AnchorFormat2::FORMAT => AnchorFormat2::read_fast(data, ()).map(AnchorTable::Format2),
            AnchorFormat3::FORMAT => AnchorFormat3::read_fast(data, ()).map(AnchorTable::Format3),
            _ => None,
        }
    }
}
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            SinglePosFormat1::FORMAT => {
                SinglePosFormat1::read_fast(data, ()).map(SinglePos::Format1)
            }
            SinglePosFormat2::FORMAT => {
                SinglePosFormat2::read_fast(data, ()).map(SinglePos::Format2)
            }
            _ => None,
        }
    }
...
impl<'a> Sanitize<'a> for PairPos<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        let format = data.read_at::<u16>(0usize).ok()?;
        match format {
            PairPosFormat1::FORMAT => PairPosFormat1::read_fast(data, ()).map(PairPos::Format1),
            PairPosFormat2::FORMAT => PairPosFormat2::read_fast(data, ()).map(PairPos::Format2),
            _ => None,
        }
    }
}
...
impl<'a> Sanitize<'a> for PairSet<'a> {
    ...
    fn read_fast(data: FontData<'a>, args: (ValueFormat, ValueFormat)) -> Option<Self> {
        let (value_format1, value_format2) = args;
        read_fast_impl!(Self {
            data,
            value_format1,
...
impl<'a> Sanitize<'a> for ExtensionSubtable<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        let discriminant = ExtensionPosFormat1::read_discriminant(data).ok()?;
        match discriminant {
            1 => {
                ExtensionPosFormat1::<SinglePos>::read_fast(data, ()).map(ExtensionSubtable::Single)
            }
            2 => ExtensionPosFormat1::<PairPos>::read_fast(data, ()).map(ExtensionSubtable::Pair),
            3 => ExtensionPosFormat1::<CursivePosFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::Cursive),
            4 => ExtensionPosFormat1::<MarkBasePosFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::MarkToBase),
            5 => ExtensionPosFormat1::<MarkLigPosFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::MarkToLig),
            6 => ExtensionPosFormat1::<MarkMarkPosFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::MarkToMark),
            7 => ExtensionPosFormat1::<PositionSequenceContext>::read_fast(data, ())
                .map(ExtensionSubtable::Contextual),
            8 => ExtensionPosFormat1::<PositionChainContext>::read_fast(data, ())
                .map(ExtensionSubtable::ChainContextual),
            _ => None,
        }
    }
}
