...
impl<'a> FontRead<'a> for FdSelectFormat3<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let ranges_byte_len = (n_ranges as usize).saturating_mul(FdSelectRange3::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for FdSelectFormat4<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let ranges_byte_len = (n_ranges as usize).saturating_mul(FdSelectRange4::RAW_BYTE_LEN);
        cursor.advance_by(ranges_byte_len);
        cursor.advance::<u32>();
