...
impl<'a> FontReadWithArgs<'a> for Stat<'a> {
...
impl<'a> AxisValueArray<'a> {
    ...
    pub fn axis_value_offsets_byte_range(&self) -> Range<usize> {
        ...
        let start = 0;
        let end = start + (axis_value_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
        start..end
    }
            ...
            0usize => Some({
                ...
                Field::new(
                    ...
                    FieldType::array_of_offsets(
                        ...
                        move |off| {
                            let target = off.get().resolve_with_args::<AxisValue>(data, &());
...
impl<'a> FontReadWithArgs<'a> for AxisValue<'a> {
    fn read_with_args(data: FontData<'a>, _: &Self::Args) -> Result<Self, ReadError> {
        Self::read(data)
    }
}
...
impl<'a> FontReadWithArgs<'a> for AxisValueFormat1<'a> {
    fn read_with_args(data: FontData<'a>, _: &Self::Args) -> Result<Self, ReadError> {
        Self::read(data)
    }
    unsafe fn read_with_args_unchecked(data: FontData<'a>, _args: &Self::Args) -> Self {
...
impl<'a> FontReadWithArgs<'a> for AxisValueFormat3<'a> {
    fn read_with_args(data: FontData<'a>, _: &Self::Args) -> Result<Self, ReadError> {
        Self::read(data)
    }
    unsafe fn read_with_args_unchecked(data: FontData<'a>, _args: &Self::Args) -> Self {
...
impl<'a> AxisValueFormat4<'a> {
    ...
    pub fn axis_values_byte_range(&self) -> Range<usize> {
        ...
        let start = self.value_name_id_byte_range().end;
        let end = start + (axis_count as usize).saturating_mul(AxisValueRecord::RAW_BYTE_LEN);
        start..end
    }
