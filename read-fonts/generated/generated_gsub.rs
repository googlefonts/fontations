...
impl<'a> MultipleSubstFormat1<'a> {
    ...
    pub fn sequences(&self) -> ArrayOfOffsets<'a, Sequence<'a>, BigEndian<Offset16>> {
        let data = self.data;
...
impl<'a> AlternateSubstFormat1<'a> {
    ...
    pub fn alternate_sets(&self) -> ArrayOfOffsets<'a, AlternateSet<'a>, BigEndian<Offset16>> {
        let data = self.data;
...
impl<'a> LigatureSubstFormat1<'a> {
    ...
    pub fn ligature_sets(&self) -> ArrayOfOffsets<'a, LigatureSet<'a>, BigEndian<Offset16>> {
        let data = self.data;
...
impl<'a> LigatureSet<'a> {
    ...
    pub fn ligatures(&self) -> ArrayOfOffsets<'a, Ligature<'a>, BigEndian<Offset16>> {
        let data = self.data;
