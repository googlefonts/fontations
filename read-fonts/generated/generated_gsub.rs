...
impl<'a> Sanitize<'a> for SubstitutionLookup<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match discriminant {
            1 => Lookup::<SingleSubst>::read_fast(data, ()).map(SubstitutionLookup::Single),
            2 => Lookup::<MultipleSubstFormat1>::read_fast(data, ())
                .map(SubstitutionLookup::Multiple),
            3 => Lookup::<AlternateSubstFormat1>::read_fast(data, ())
                .map(SubstitutionLookup::Alternate),
            4 => Lookup::<LigatureSubstFormat1>::read_fast(data, ())
                .map(SubstitutionLookup::Ligature),
            5 => Lookup::<SubstitutionSequenceContext>::read_fast(data, ())
                .map(SubstitutionLookup::Contextual),
            6 => Lookup::<SubstitutionChainContext>::read_fast(data, ())
                .map(SubstitutionLookup::ChainContextual),
            7 => {
                Lookup::<ExtensionSubtable>::read_fast(data, ()).map(SubstitutionLookup::Extension)
            }
            8 => Lookup::<ReverseChainSingleSubstFormat1>::read_fast(data, ())
                .map(SubstitutionLookup::Reverse),
            _ => None,
        }
    }
}
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        ...
        match format {
            SingleSubstFormat1::FORMAT => {
                SingleSubstFormat1::read_fast(data, ()).map(SingleSubst::Format1)
            }
            SingleSubstFormat2::FORMAT => {
                SingleSubstFormat2::read_fast(data, ()).map(SingleSubst::Format2)
            }
            _ => None,
        }
    }
...
impl<'a> MultipleSubstFormat1<'a> {
    ...
    pub fn sequence_offsets_byte_range(&self) -> Range<usize> {
        ...
        let end =
            start + (transforms::to_usize(sequence_count)).saturating_mul(Offset16::RAW_BYTE_LEN);
        start..end
    }
}
...
impl<'a> Sanitize<'a> for ExtensionSubtable<'a> {
    ...
    fn read_fast(data: FontData<'a>, _args: ()) -> Option<Self> {
        let discriminant = ExtensionSubstFormat1::read_discriminant(data).ok()?;
        match discriminant {
            1 => ExtensionSubstFormat1::<SingleSubst>::read_fast(data, ())
                .map(ExtensionSubtable::Single),
            2 => ExtensionSubstFormat1::<MultipleSubstFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::Multiple),
            3 => ExtensionSubstFormat1::<AlternateSubstFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::Alternate),
            4 => ExtensionSubstFormat1::<LigatureSubstFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::Ligature),
            5 => ExtensionSubstFormat1::<SubstitutionSequenceContext>::read_fast(data, ())
                .map(ExtensionSubtable::Contextual),
            6 => ExtensionSubstFormat1::<SubstitutionChainContext>::read_fast(data, ())
                .map(ExtensionSubtable::ChainContextual),
            8 => ExtensionSubstFormat1::<ReverseChainSingleSubstFormat1>::read_fast(data, ())
                .map(ExtensionSubtable::Reverse),
            _ => None,
        }
    }
}
