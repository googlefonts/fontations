...
impl<'a> FontRead<'a> for SingleSubstFormat2<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let substitute_glyph_ids_byte_len =
            (glyph_count as usize).saturating_mul(GlyphId::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for MultipleSubstFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let sequence_offsets_byte_len =
            (sequence_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for AlternateSubstFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let alternate_set_offsets_byte_len =
            (alternate_set_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for AlternateSet<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        let mut cursor = data.cursor();
        let glyph_count: u16 = cursor.read()?;
        let alternate_glyph_ids_byte_len =
            (glyph_count as usize).saturating_mul(GlyphId::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for LigatureSubstFormat1<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let ligature_set_offsets_byte_len =
            (ligature_set_count as usize).saturating_mul(Offset16::RAW_BYTE_LEN);
...
impl<'a> FontRead<'a> for Ligature<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        let component_glyph_ids_byte_len =
            (transforms::subtract(component_count, 1_usize)).saturating_mul(GlyphId::RAW_BYTE_LEN);
