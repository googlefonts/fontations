...
impl<'a> FontRead<'a> for Cmap<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        cursor.advance::<u16>();
        cursor.advance::<u16>();
        let encoding_records_byte_len = compile_error!("missing count attribute?");
...
impl<'a> Cmap<'a> {
    ...
    pub fn encoding_records(&self) -> &'a [BigEndian<EncodingRecord>] {
...
impl<'a> FontRead<'a> for Cmap0<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        cursor.advance::<u16>();
        cursor.advance::<u16>();
        let glyph_id_array_byte_len = compile_error!("missing count attribute?");
...
impl<'a> Cmap0<'a> {
    ...
    pub fn glyph_id_array(&self) -> &'a [BigEndian<BigEndian>; 256u32] {
...
impl<'a> FontRead<'a> for Cmap2<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        cursor.advance::<u16>();
        cursor.advance::<u16>();
        let sub_header_keys_byte_len = compile_error!("missing count attribute?");
...
impl<'a> Cmap2<'a> {
    ...
    /// index × 8.
    pub fn sub_header_keys(&self) -> &'a [BigEndian<BigEndian>; 256u32] {
...
impl<'a> FontRead<'a> for Cmap4<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        cursor.advance::<u16>();
        cursor.advance::<u16>();
        let end_code_byte_len = compile_error!("missing count attribute?");
        cursor.advance_by(end_code_byte_len);
        cursor.advance::<u16>();
        let start_code_byte_len = compile_error!("missing count attribute?");
        cursor.advance_by(start_code_byte_len);
        let id_delta_byte_len = compile_error!("missing count attribute?");
        cursor.advance_by(id_delta_byte_len);
        let id_range_offsets_byte_len = compile_error!("missing count attribute?");
...
impl<'a> Cmap4<'a> {
    ...
    pub fn end_code(&self) -> &'a [BigEndian<BigEndian>] {
        let range = self.shape.end_code_byte_range();
        self.data.read_at(range.start).unwrap()
    }

    /// Start character code for each segment.
    pub fn start_code(&self) -> &'a [BigEndian<BigEndian>] {
        let range = self.shape.start_code_byte_range();
        self.data.read_at(range.start).unwrap()
    }

    /// Delta for all character codes in segment.
    pub fn id_delta(&self) -> &'a [BigEndian<BigEndian>] {
        let range = self.shape.id_delta_byte_range();
        self.data.read_at(range.start).unwrap()
    }

    /// Offsets into glyphIdArray or 0
    pub fn id_range_offsets(&self) -> &'a [BigEndian<BigEndian>] {
        let range = self.shape.id_range_offsets_byte_range();
        self.data.read_at(range.start).unwrap()
    }

    /// Glyph index array (arbitrary length)
    pub fn glyph_id_array(&self) -> &'a [BigEndian<BigEndian>] {
        let range = self.shape.glyph_id_array_byte_range();
        self.data.read_at(range.start).unwrap()
    }
}
...
impl<'a> FontRead<'a> for Cmap8<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        cursor.advance::<u32>();
        cursor.advance::<u32>();
        let is32_byte_len = compile_error!("missing count attribute?");
        cursor.advance_by(is32_byte_len);
        cursor.advance::<u32>();
        let groups_byte_len = compile_error!("missing count attribute?");
...
impl<'a> Cmap8<'a> {
    ...
    pub fn is32(&self) -> &'a [BigEndian<BigEndian>; 8192u32] {
    ...
    pub fn groups(&self) -> &'a [BigEndian<SequentialMapGroup>] {
...
impl<'a> Cmap13<'a> {
    ...
    pub fn groups(&self) -> &'a [BigEndian<ConstantMapGroup>] {
        let range = self.shape.groups_byte_range();
        self.data.read_at(range.start).unwrap()
    }
}
...
impl<'a> FontRead<'a> for Cmap14<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        ...
        cursor.advance::<u32>();
        cursor.advance::<u32>();
        let var_selector_byte_len = compile_error!("missing count attribute?");
...
impl<'a> Cmap14<'a> {
    ...
    pub fn var_selector(&self) -> &'a [BigEndian<VariationSelector>] {
...
impl<'a> FontRead<'a> for DefaultUvs<'a> {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        let mut cursor = data.cursor();
        cursor.advance::<u32>();
        let ranges_byte_len = compile_error!("missing count attribute?");
...
impl<'a> DefaultUvs<'a> {
    ...
    pub fn ranges(&self) -> &'a [BigEndian<UnicodeRange>] {
