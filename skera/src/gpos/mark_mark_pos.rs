...
impl<'a> SubsetTable<'a> for MarkMarkPosFormat1<'_> {
    ...
    fn subset(
        ...
        let (mark1_glyphs, mark1_record_idxes) = intersected_glyphs_and_indices(
            &mark1_coverage,
            glyph_set,
            glyph_map,
            mark1_array.mark_count(),
        );
        ...
        let (mark2_glyphs, mark2_record_idxes) = intersected_glyphs_and_indices(
            &mark2_coverage,
            glyph_set,
            glyph_map,
