...
pub use native_hint::{NativeHinting, NativeHintingInstance};
...
/// Specifies the hinting strategy.
#[derive(Copy, Clone, PartialEq, Eq, Default, Debug)]
pub enum Hinting {
    /// Hinting is disabled.
    #[default]
    None,
    /// Will apply native embedded hints.
    Native,
}
...
impl<'a> DrawSettings<'a> {
    ...
    pub fn new(size: Size, location: impl Into<LocationRef<'a>>) -> Self {
        Self {
    ...
    /// Creates settings for a native hinted draw operation.
    ///
    ...
    pub fn native_hinted(instance: &'a NativeHintingInstance) -> Self {
        Self {
            instance: DrawInstance::NativeHinted(instance),
            memory: None,
        }
    }
...
enum DrawInstance<'a> {
    ...
    NativeHinted(&'a NativeHintingInstance),
}
    ...
    L: Into<LocationRef<'a>>,
{
    fn from(value: (Size, L)) -> Self {
        DrawSettings::new(value.0, value.1.into())
    }
}

impl From<Size> for DrawSettings<'_> {
    fn from(value: Size) -> Self {
        DrawSettings::new(value, LocationRef::default())
    }
}

impl<'a> From<&'a NativeHintingInstance> for DrawSettings<'a> {
    fn from(value: &'a NativeHintingInstance) -> Self {
        DrawSettings::native_hinted(value)
    }
}
...
impl<'a> OutlineGlyph<'a> {
    ...
    pub fn draw<'s>(
        ...
        match settings.instance {
            ...
            DrawInstance::NativeHinted(hinter) => hinter.draw_hinted(self, settings.memory, pen),
        }
    }
