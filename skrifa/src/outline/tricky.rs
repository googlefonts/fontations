...
pub(super) fn is_tricky(font: &FontRef) -> bool {
    has_tricky_name(font) || is_tricky_font_id(FontId::from_font(font))
}
...
impl FontId {
    fn from_font(font: &FontRef) -> Self {
        Self {
            ...
            prep: TableId::from_font_and_tag(font, Tag::new(b"prem")).unwrap_or_default(),
        }
    }
}

/// Checks for tricky fonts based on the length and checksum of the cvt,
