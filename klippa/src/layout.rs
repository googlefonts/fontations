...
use crate::{
    ...
    CollectVaritionaIndices, NameIdClosure, Plan, SubsetArgs, SubsetTable, SubsetTableWithArgs,
};
use fnv::FnvHashMap;
...
impl SubsetArgs for DeviceOrVariationIndex<'_> {
    type Args = FnvHashMap<u32, (u32, i32)>;
}
...
impl SubsetArgs for VariationIndex<'_> {
    type Args = FnvHashMap<u32, (u32, i32)>;
}
