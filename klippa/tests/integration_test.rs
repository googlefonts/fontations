...
impl SubsetTestCase {
    ...
    fn gen_expected_output_for_one_test(
        ...
        Command::new("fonttools")
            .arg("subset")
            .arg(&org_font_file)
            .arg("--drop-tables+=DSIG,GSUB,GPOS,GDEF,fpgm,prep,cvt,gasp,cvar,STAT")
...
fn gen_subset_font_file(
    ...
    let drop_tables_str = "morx,mort,kerx,kern,JSTF,DSIG,EBDT,EBLC,EBSC,SVG,PCLT,LTSH,feat,Glat,Gloc,Silf,Sill,GSUB,GPOS,GDEF,fpgm,prep,cvt,gasp,cvar,STAT";
