...
pub struct PatchMapFormat1 {
    ...
    pub feature_map: OffsetMarker<FeatureMap, WIDTH_32>,
...
impl<'a> FromObjRef<read_fonts::tables::ift::FeatureRecord<'a>> for FeatureRecord {
    fn from_obj_ref(obj: &read_fonts::tables::ift::FeatureRecord<'a>, _: FontData) -> Self {
        FeatureRecord {}
    }
}

impl<'a> FromTableRef<read_fonts::tables::ift::FeatureRecord<'a>> for FeatureRecord {}

impl<'a> FontRead<'a> for FeatureRecord {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <read_fonts::tables::ift::FeatureRecord as FontRead>::read(data).map(|x| x.to_owned_table())
    }
}
...
impl<'a> FromObjRef<read_fonts::tables::ift::EntryMapRecord<'a>> for EntryMapRecord {
    fn from_obj_ref(obj: &read_fonts::tables::ift::EntryMapRecord<'a>, _: FontData) -> Self {
        EntryMapRecord {}
    }
}

impl<'a> FromTableRef<read_fonts::tables::ift::EntryMapRecord<'a>> for EntryMapRecord {}

impl<'a> FontRead<'a> for EntryMapRecord {
    fn read(data: FontData<'a>) -> Result<Self, ReadError> {
        <read_fonts::tables::ift::EntryMapRecord as FontRead>::read(data)
            .map(|x| x.to_owned_table())
    }
}
