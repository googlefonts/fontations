...
impl Cmap {
    ...
    pub fn new(version: u16, encoding_records: Vec<EncodingRecord>) -> Self {
        Self {
            version,
...
impl CmapSubtable {
    ...
    pub fn format_2(language: u16, sub_header_keys: Vec<u16>) -> Self {
        Self::Format2(Cmap2::new(language, sub_header_keys))
    }
    ...
    pub fn format_8(
        ...
        Self::Format8(Cmap8::new(
            reserved, length, language, is32, num_groups, groups,
        ))
    }
    ...
    pub fn format_12(
        ...
        Self::Format12(Cmap12::new(reserved, length, language, num_groups, groups))
    }
    ...
    pub fn format_13(
        ...
        Self::Format13(Cmap13::new(reserved, length, language, num_groups, groups))
    }
...
impl Cmap2 {
    ...
    pub fn new(language: u16, sub_header_keys: Vec<u16>) -> Self {
        Self {
            language,
...
impl FontWrite for Cmap2 {
    ...
    fn write_into(&self, writer: &mut TableWriter) {
        ...
        (panic!("not implemented") as u16).write_into(writer);
        self.language.write_into(writer);
...
impl FontWrite for Cmap4 {
    ...
    fn write_into(&self, writer: &mut TableWriter) {
        ...
        self.reserved_pad.write_into(writer);
